...
paper_8_install () {
	...
	dialog --title "This will install paper 1.8.9." --msgbox "This will install paper 1.18.9" 7 60
	...
	echo "-------------------------------------"
	wget -O minecraft-server.jar "https://papermc.io/api/v2/projects/paper/versions/1.8.8/builds/443/downloads/paper-1.8.8-443.jar"
...
vanilla_8_install () {
	...
	dialog --title "This will install vanilla 1.8.9." --msgbox "This will install vanilla 1.18.9" 7 60
	...
	echo "Downloading Minecraft"
	echo "-------------------------------------"
	wget -O minecraft-server.jar "https://launcher.mojang.com/v1/objects/b58b2ceb36e01bcd8dbf49c8fb66c55a9f0676cd/server.jar"
	chmod +x minecraft-server.jar
...
forge_16_install () {
	dialog --title "this will install forge 1.16.4" --msgbox "This will install forge 1.16.4" 7 60
...
forge_12_install () {
	dialog --title "this will install forge 1.12.2" --msgbox "This will install forge 1.12.2" 7 60
...
vanilla_16_install () { 
	...
	total_ram=$(free -m | awk '{print $2}' | sed -n 2p)
	ram_message="How much ram (in megabytes) will you like to dedicate to the server. You have ""$total_ram"" in total."
...
minecraft_version_8 () {
	...
	dialog --title "1.8.9" --msgbox "You chose 1.8.9, in the next menu you can select what type of server you would like. If you are new to running a server I recommend using vanilla." 7 60
	dialog --title "What server would you like to use." --menu "" 15 70 3 Vanilla "The official minecraft server." Paper "Minecraft with anticheat" 2> /tmp/minecraft_autoconfig_dialog2
...
dialog --title "What version of minecraft would you like to use." --menu "" 15 95 4 1.16.4 "The most recent version supported by this script, but it is bad for modded" 1.12.2 "The best version from modded minecraft." 1.8.9 "The best for PVP" 2> /tmp/minecraft_autoconfig_dialog1
